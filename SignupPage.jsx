...
const SignupPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post("http://localhost:8080/employee/SignupPage", userData)
            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div>
                            <label htmlFor="name-address" className="sr-only">Your Name</label>
                            <input
                                id="name-address"
                                name="name"
                                type="text"
                        ...
                        <div>
                            <label htmlFor="department-address" className="sr-only">Department</label>
                            <input
                        ...
                        <div>
                            <label htmlFor="position-address" className="sr-only">Your Role</label>
                            <input
                                id="position-address"
                                name="position"
                                type="text"
                    ...
                    <div className="text-center mt-4">
                        <p className="text-sm">
                            ...
                            <a href="/LoginPage" className="font-medium text-gradient-from-red-700-to-black hover:text-red-900">
                                Log in
                            </a>
                        </p>
                    </div>
